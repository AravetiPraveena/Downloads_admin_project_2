    ...
    <div>
      ...
      <div className="IItMainDownloads">
        <div className="IitMainHeading">
          <h2>JEST - PREVIOUS QUESTION PAPERS WITH SOLUTIONS</h2>
        </div>
        <div className="Iitmainstablediv">
          ...
          <table className="Iitmainstable">
            <tr className="Iitmainstrheading">
              <th colSpan={4}>JEST - 2024 JANUARY SESSION</th>
            </tr>
            <tr>
              <th>S.No</th>
              <th>DATE/SESSION</th>
          ...
          <table className="Iitmainstable">
            <tr className="Iitmainstrheading">
              <th colSpan={4}>JEST - 2024 FEBRUARY SESSION</th>
            </tr>
            <tr>
              <th>S.No</th>
              <th>DATE/SESSION</th>
...
export default JestDownloadPage