    ...
    <div>
      ...
      <div className="IItMainDownloads">
        <div className="IitMainHeading">
          <h2>ESE - PREVIOUS QUESTION PAPERS WITH SOLUTIONS</h2>
        </div>
        <div className="Iitmainstablediv">
          ...
          <table className="Iitmainstable">
            <tr className="Iitmainstrheading">
              <th colSpan={4}>ESE - 2024 JANUARY SESSION</th>
            </tr>
            <tr>
              <th>S.No</th>
              <th>DATE/SESSION</th>
          ...
          <table className="Iitmainstable">
            <tr className="Iitmainstrheading">
              <th colSpan={4}>ESE - 2024 FEBRUARY SESSION</th>
            </tr>
            <tr>
              <th>S.No</th>
              <th>DATE/SESSION</th>
...
export default EseDownloadPage
...
//   const [esePdfs, setEsePdfs] = useState([]);

//   useEffect(() => {
//     const fetchPdfs = async () => {
//       try {
//         const response = await axios.get('http://localhost:5007/exams_pdfs');
//         const esePdfsData = response.data.filter(pdf => pdf.description.trim().toLowerCase().includes('ese'));
//         setEsePdfs(esePdfsData);
//         setPdfs(esePdfsData); // Initialize pdfs with ESE PDFs
//         console.log('ESE PDFs:', esePdfsData);
//       } catch (err) {
...
//     const filteredPdfs = esePdfs.filter(pdf => pdf.description.toLowerCase().includes(query));
...
//           <thead>
//             <tr className="Iitmainstrheading">
//               <th colSpan={4}>ESE - 2024 SESSION</th>
//             </tr>
//             <tr>
//               <th>S.NO</th>
//               <th>DATE/SESSION</th>
