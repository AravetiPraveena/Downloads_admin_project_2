...
// import Examheader from '/PG_DOWNLOAD'
...
function IitjeeDownloadPage() {
    ...
    useEffect(() => {
        const fetchPdfs = async () => {
            try {
                const response = await axios.get(`http://localhost:5007/server1/exams_pdfs/${exam_id}/102`);
...
<div className="IitMainHeading" style={{ backgroundColor: 'black', width: '100%' }}>
    <h2 style={{ color: 'white' }}>List of PDFs</h2>
</div>
